...
static const char col_accent[]      = "#ca9ee6";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg, col_bg, col_bg },
	[SchemeSel]  = { col_bg, col_accent,  col_accent  },
	[SchemeStatus]  = { col_bg, col_accent,  "#000000"  }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { col_bg, col_accent,  "#000000"  }, // Tagbar left selected {text,background,not used but cannot be empty}
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_n,  setgaps,        {.i = -5 } },
	{ MODKEY,                       XK_u,  setgaps,        {.i = +5 } },
